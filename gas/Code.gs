...
function readSettings_(ss) {
  ...
  return {
    namaToko: map.NAMA_TOKO || 'Kedai Pisang Queena',
    alamat: map.ALAMAT || '',
    telepon: map.TELEPON || '',
...
const SAMPLE_MENU = [
  ['m01', 'Pisang Goreng Madu', 12000, 'Pisang Goreng', '🍯', 'TRUE', ''],
  ['m02', 'Pisang Goreng Original', 11000, 'Pisang Goreng', '🍌', 'TRUE', ''],
  ['m03', 'Pisang Goreng Coklat', 11000, 'Pisang Goreng', '🍫', 'TRUE', ''],
  ['m04', 'Pisang Goreng Keju', 11000, 'Pisang Goreng', '🧀', 'TRUE', ''],
  ['m05', 'Pisang Goreng Coklat Keju', 11000, 'Pisang Goreng', '🍫🧀', 'TRUE', ''],
  ['m06', 'Pisang Goreng Oreo', 11000, 'Pisang Goreng', '🍪', 'TRUE', ''],
  ['m07', 'Pisang Goreng Gula Aren', 11000, 'Pisang Goreng', '🍯', 'TRUE', ''],
  ['m08', 'Pisang Goreng Tiramisu', 11000, 'Pisang Goreng', '🍰', 'TRUE', ''],
  ['m09', 'Pisang Goreng Matcha', 11000, 'Pisang Goreng', '🍵', 'TRUE', ''],
  ['m10', 'Pisang Goreng Redvelvet', 11000, 'Pisang Goreng', '🧁', 'TRUE', ''],
  ['m11', 'Pisang Goreng Vanila', 11000, 'Pisang Goreng', '🍦', 'TRUE', ''],
  ['m12', 'Pisang Goreng Strawberry', 11000, 'Pisang Goreng', '🍓', 'TRUE', ''],
  ['m13', 'Pisang Goreng Cappucino', 11000, 'Pisang Goreng', '☕', 'TRUE', ''],
  ['m14', 'Pisang Goreng Blueberry', 11000, 'Pisang Goreng', '🫐', 'TRUE', ''],
  ['m15', 'Pisang Goreng Taro', 11000, 'Pisang Goreng', '🍠', 'TRUE', ''],
  ['m16', 'Pisang Katsu Original', 13000, 'Pisang Katsu', '🍢', 'TRUE', ''],
  ['m17', 'Pisang Katsu Susu', 13000, 'Pisang Katsu', '🥛', 'TRUE', ''],
  ['m18', 'Pisang Katsu Karamel', 13000, 'Pisang Katsu', '🍮', 'TRUE', ''],
  ['m19', 'Pisang Katsu Coklat', 13000, 'Pisang Katsu', '🍫', 'TRUE', ''],
  ['m20', 'Pisang Katsu Keju', 13000, 'Pisang Katsu', '🧀', 'TRUE', ''],
  ['m21', 'Pisang Katsu Coklat Keju', 13000, 'Pisang Katsu', '🍫🧀', 'TRUE', ''],
  ['m22', 'Pisang Katsu Oreo', 13000, 'Pisang Katsu', '🍪', 'TRUE', ''],
  ['m23', 'Pisang Katsu Tiramisu', 13000, 'Pisang Katsu', '🍰', 'TRUE', ''],
  ['m24', 'Pisang Katsu Matcha', 13000, 'Pisang Katsu', '🍵', 'TRUE', ''],
  ['m25', 'Pisang Katsu Redvelvet', 13000, 'Pisang Katsu', '🧁', 'TRUE', ''],
  ['m26', 'Pisang Katsu Vanila', 13000, 'Pisang Katsu', '🍦', 'TRUE', ''],
  ['m27', 'Pisang Katsu Strawberry', 13000, 'Pisang Katsu', '🍓', 'TRUE', ''],
  ['m28', 'Pisang Katsu Cappucino', 13000, 'Pisang Katsu', '☕', 'TRUE', ''],
  ['m29', 'Pisang Katsu Blueberry', 13000, 'Pisang Katsu', '🫐', 'TRUE', ''],
  ['m30', 'Pisang Katsu Taro', 13000, 'Pisang Katsu', '🍠', 'TRUE', ''],
  ['m31', 'Pisang Bakar Original', 11000, 'Pisang Bakar', '🍌', 'TRUE', ''],
  ['m32', 'Pisang Bakar Karamel', 11000, 'Pisang Bakar', '🍮', 'TRUE', ''],
  ['m33', 'Pisang Bakar Coklat', 11000, 'Pisang Bakar', '🍫', 'TRUE', ''],
  ['m34', 'Pisang Bakar Keju', 11000, 'Pisang Bakar', '🧀', 'TRUE', ''],
  ['m35', 'Pisang Bakar Coklat Keju', 11000, 'Pisang Bakar', '🍫🧀', 'TRUE', ''],
  ['m36', 'Pisang Bakar Oreo', 11000, 'Pisang Bakar', '🍪', 'TRUE', ''],
  ['m37', 'Pisang Bakar Gula Aren', 11000, 'Pisang Bakar', '🍯', 'TRUE', ''],
  ['m38', 'Pisang Bakar Tiramisu', 11000, 'Pisang Bakar', '🍰', 'TRUE', ''],
  ['m39', 'Pisang Bakar Matcha', 11000, 'Pisang Bakar', '🍵', 'TRUE', ''],
  ['m40', 'Pisang Bakar Redvelvet', 11000, 'Pisang Bakar', '🧁', 'TRUE', ''],
  ['m41', 'Pisang Bakar Vanila', 11000, 'Pisang Bakar', '🍦', 'TRUE', ''],
  ['m42', 'Pisang Bakar Strawberry', 11000, 'Pisang Bakar', '🍓', 'TRUE', ''],
  ['m43', 'Pisang Bakar Blueberry', 11000, 'Pisang Bakar', '🫐', 'TRUE', ''],
  ['m44', 'Pisang Bakar Taro', 11000, 'Pisang Bakar', '🍠', 'TRUE', ''],
  ['m45', 'Lumpia Pisang Original', 12000, 'Lumpia Pisang', '🥟', 'TRUE', ''],
  ['m46', 'Lumpia Pisang Karamel', 12000, 'Lumpia Pisang', '🍮', 'TRUE', ''],
  ['m47', 'Lumpia Pisang Coklat', 12000, 'Lumpia Pisang', '🍫', 'TRUE', ''],
  ['m48', 'Lumpia Pisang Keju', 12000, 'Lumpia Pisang', '🧀', 'TRUE', ''],
  ['m49', 'Lumpia Pisang Coklat Keju', 12000, 'Lumpia Pisang', '🍫🧀', 'TRUE', ''],
  ['m50', 'Lumpia Pisang Tiramisu', 12000, 'Lumpia Pisang', '🍰', 'TRUE', ''],
  ['m51', 'Lumpia Pisang Matcha', 12000, 'Lumpia Pisang', '🍵', 'TRUE', ''],
  ['m52', 'Lumpia Pisang Vanila', 12000, 'Lumpia Pisang', '🍦', 'TRUE', ''],
  ['m53', 'Lumpia Pisang Strawberry', 12000, 'Lumpia Pisang', '🍓', 'TRUE', ''],
  ['m54', 'Lumpia Pisang Blueberry', 12000, 'Lumpia Pisang', '🫐', 'TRUE', ''],
  ['m55', 'Lumpia Pisang Taro', 12000, 'Lumpia Pisang', '🍠', 'TRUE', ''],
];
...
function setup_(ss, reset) {
  ...
  ensureSetting_('NAMA_TOKO', 'Kedai Pisang Queena');
